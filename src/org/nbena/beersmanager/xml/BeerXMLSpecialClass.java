...
public class BeerXMLSpecialClass {
//	private String name;
...
//
//
//	public BeerXMLSpecialClass(String name, String breweryName, String styleMainName, String styleSubcategory) {
//		super();
//		this.name = name;
...
//
//
//	public BeerXMLSpecialClass(String name, String breweryName, String styleMainName, String styleSubcategory, int numberOfStars) {
//		super();
//		this.name = name;
//		this.breweryName = breweryName;
//		this.styleMainName = styleMainName;
